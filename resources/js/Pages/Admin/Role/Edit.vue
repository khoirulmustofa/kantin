        ...
        <form @submit.prevent="submit" class="mx-auto space-y-8 pb-20">
            ...
            <div
                ...
                <div class="flex items-center gap-4">
                    ...
                    <h2 class="text-xl font-black text-gray-900 dark:text-white tracking-tight italic">Editing: {{
                        role.name }}</h2>
                </div>
                <div class="flex gap-3">
                    ...
                    <Button type="submit" label="Update Role" icon="pi pi-save" :loading="form.processing"
                        severity="success" />
                </div>
            </div>
            ...
            <!-- Basic Information -->
            <div
                class="card bg-white dark:bg-gray-800 p-8 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm space-y-6">
                <div class="flex items-center gap-2 mb-4">
                    <div class="w-1 h-6 bg-green-500 rounded-full"></div>
                    <h3 class="font-black text-lg text-gray-900 dark:text-white  tracking-tight">Basic
                        Information</h3>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <InputText id="name" v-model="form.name" placeholder="Enter role name"
            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between px-2">
                    ...
                    <div
                        ...
                        <span class="font-black  tracking-widest text-green-600">
                            Select All
                        </span>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div v-for="permission in groupPermissions" :key="permission.id"
                                ...
                                :class="form.permissions.includes(permission.name)
                                    ? 'bg-green-50 dark:bg-green-900/10 border-green-200/50 ring-1 ring-green-100/50'
                                ...
                                <span class="font-black  tracking-tight group-hover:translate-x-1 transition-transform"
                                    :class="form.permissions.includes(permission.name) ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-400'">
                                    {{ permission.name }}
                                </span>
