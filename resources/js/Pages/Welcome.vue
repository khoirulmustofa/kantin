...
<template>
        ...
        <div class="main-slider swiper overflow-hidden">
            <div class="swiper-wrapper">
                <div class="swiper-slide relative">
                    ...
                    <div class="swiper-slide-content absolute inset-0 flex flex-col justify-center items-center text-center">
                        ...
                        <Link href="/" class="bg-primary hover:bg-transparent text-white border border-transparent hover:border-white font-semibold px-4 py-2 rounded-full">
                            Shop now
                        </Link>
                    </div>
                </div>
                ...
                <div class="swiper-slide relative">
                    ...
                    <div class="swiper-slide-content absolute inset-0 flex flex-col justify-center items-center text-center">
                        ...
                        <p class="mb-4 text-white md:text-2xl">Discover the latest trends in Men's <br>sportswear.</p>
                        <Link href="/" class="bg-white hover:bg-transparent text-black hover:text-white font-semibold px-4 py-2 rounded-full border border-transparent hover:border-white">
                            Shop now
                        </Link>
                    </div>
                </div>
    ...
    <section id="popular-products" class="bg-gray-100">
    ...
    <section id="latest-products" class="bg-white py-10">
